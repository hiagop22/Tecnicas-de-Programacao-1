...
/// PadrÃ£o para codificaÃ§Ã£o de produtos.
class Produto{
    private:
        ...
        static int quantidadeInstancias;
    public:
        /// \brief Incrementa a variÃ¡vel responsÃ¡vel por armazenar o nÃºmero de instancias da classe Produto.
        Produto();
        /// \brief Decrementa a variÃ¡vel responsÃ¡vel por armazenar o nÃºmero de instancias da classe Produto.
        virtual ~Produto();
        /// \return Quantidade de instÃ¢ncias da classe Produto.
        static int getQuantidadeInstancias();

        /// \brief Define o codigo como o parÃ¢metro recebido.
        void setCodigo(const CodigoProduto&);
        /// \brief Retorna o codigo, caso o mesmo tenha sido passado para o mÃ©todo set.
        /// \return codigo cadastrado.
        CodigoProduto getCodigo() const;
        /// \brief Define a classe como o parÃ¢metro recebido.
        void setClasse(const Classe&);
        /// \brief Retorna a classe, caso o mesmo tenha sido passado para o mÃ©todo set.
        /// \return classe cadastrado.
        Classe getClasse() const;
        /// \brief Define o emissor como o parÃ¢metro recebido.
        void setEmissor(const Emissor&);
        /// \brief Retorna a classe, caso o mesmo tenha sido passado para o mÃ©todo set.
        /// \return classe cadastrado.
        Emissor getEmissor() const;
        /// \brief Define o prazo como o parÃ¢metro recebido.
        void setPrazo(const Prazo&);
        /// \brief Retorna a classe, caso o mesmo tenha sido passado para o mÃ©todo set.
        /// \return classe cadastrado.
        Prazo getPrazo() const;
        /// \brief Define o vencimento como o parÃ¢metro recebido.
        void setVencimento(const Data&);
        /// \brief Retorna o vencimento, caso o mesmo tenha sido passado para o mÃ©todo set.
        /// \return vencimento cadastrado.
        Data getVencimento() const;
        /// \brief Define a taxa como o parÃ¢metro recebido.
        void setTaxa(const Taxa&);
        /// \brief Retorna a taxa, caso o mesmo tenha sido passado para o mÃ©todo set.
        /// \return taxa cadastrado.
        Taxa getTaxa() const;
        /// \brief Define o horÃ¡rio como o parÃ¢metro recebido.
        void setHorario(const Horario&);
        Horario getHorario() const;
        /// \brief Define o valor como o parÃ¢metro recebido.
        void setValor(const ValorMinimo&);
        /// \brief Retorna o valor, caso o mesmo tenha sido passado para o mÃ©todo set.
...
/// PadrÃ£o para codificaÃ§Ã£o de usuÃ¡rios.
class Usuario{
    private:
        Nome nome;
        Endereco endereco;
        ...
        static int quantidadeInstancias;
    public:
        /// \brief Incrementa a variÃ¡vel responsÃ¡vel por armazenar o nÃºmero de instancias da classe Usuario.
        Usuario();
        /// \brief Decrementa a variÃ¡vel responsÃ¡vel por armazenar o nÃºmero de instancias da classe Usuario.
        virtual ~Usuario();
        /// \return Quantidade de instÃ¢ncias da classe Usuario.
        static int getQuantidadeInstancias();

        /// \brief Define o nome como o parÃ¢metro recebido.
        void setNome(const Nome&);
        /// \brief Retorna o nome, caso o mesmo tenha sido passado para o mÃ©todo set.
        /// \return nome cadastrado.
        Nome getNome() const;
        /// \brief Define o endereco como o parÃ¢metro recebido
        void setEndereco(const Endereco&);
        /// \brief Retorna o endereco, caso o mesmo tenha sido passado para o mÃ©todo set.
        /// \return endereco cadastrado.
        Endereco getEndereco() const;
        /// \brief Define o cep como o parÃ¢metro recebido
        void setCep(const Cep&);
        /// \brief Retorna o cep, caso o mesmo tenha sido passado para o mÃ©todo set.
        /// \return cep cadastrado.
        Cep getCep() const;
        /// \brief Define o cpf como o parÃ¢metro recebido
        void setCpf(const Cpf&);
        /// \brief Retorna o cpf, caso o mesmo tenha sido passado para o mÃ©todo set.
        /// \return cpf cadastrado.
        Cpf getCpf() const;
        /// \brief Define a senha como o parÃ¢metro recebido
        void setSenha(const Senha&);
        /// \brief Retorna a senha, caso o mesmo tenha sido passado para o mÃ©todo set.
